...
mod test {
    ...
    star_test!(example1a, star1, IN1, "2");
    star_test!(me1, star1, ME, "237");

    star_test!(example1b, star2, IN1, "2");
    star_test!(example2, star2, IN2, "0");
    star_test!(example3, star2, IN3, "4");
    star_test!(me2, star2, ME, "172");
