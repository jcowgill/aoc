...
mod test {
    ...
    star_test!(example1, star1, IN1, "4");
    star_test!(example2, star1, IN2, "4");
    star_test!(example3, star1, IN3, "8");
    star_test!(example4, star1, IN4, "8");
    star_test!(me1, star1, ME, "6903");

    star_test!(example1a, star2, IN1, "1");
    star_test!(example2a, star2, IN2, "1");
    star_test!(example3a, star2, IN3, "1");
    star_test!(example4a, star2, IN4, "1");
    star_test!(example5a, star2, IN5, "4");
    star_test!(example6a, star2, IN6, "4");
    star_test!(example7a, star2, IN7, "8");
    star_test!(example8a, star2, IN8, "10");
    star_test!(me2, star2, ME, "265");
